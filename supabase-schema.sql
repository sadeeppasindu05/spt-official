-- Supabase SQL Schema for Sadeep Pasindu Creative Universe
-- RLS (Row Level Security) enabled: only authenticated admins can edit. Public can read.

-- 1. Profiles / Users (Optional extension of auth.users)
...
-- Drop existing policies first to prevent "already exists" errors when running multiple times
...
-- 13. System Configuration Settings (Logo, Title, Themes, Custom texts)
